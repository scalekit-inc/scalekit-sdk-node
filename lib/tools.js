...
class ToolsClient {
    ...
    listTools(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            })), ((options === null || options === void 0 ? void 0 : options.pageSize) !== undefined && { pageSize: options.pageSize })), ((options === null || options === void 0 ? void 0 : options.pageToken) && { pageToken: options.pageToken }))), { timeoutMs: this.coreClient.toolTimeoutMs });
        });
    }
    /**
    ...
    listAvailableTools(identifier, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.coreClient.connectExec(this.client.listAvailableTools, (0, protobuf_1.create)(tools_pb_1.ListAvailableToolsRequestSchema, Object.assign(Object.assign({ identifier }, ((options === null || options === void 0 ? void 0 : options.pageSize) !== undefined && { pageSize: options.pageSize })), ((options === null || options === void 0 ? void 0 : options.pageToken) && { pageToken: options.pageToken }))), { timeoutMs: this.coreClient.toolTimeoutMs });
        });
    }
    /**
     ...
     * connection, or needs re-auth) on each result's `connections`. `connections` is
     * populated only when `identifier` is set: an empty array means the identifier has
     * no connection at all for that tool's provider (not an error, and different from
     * `NEEDS_CONNECTION`, which means a connected-account row exists but is inactive);
     * more than one entry means the identifier has accounts on multiple connections for
     * that provider (for example, two Slack workspaces) — inspect each entry's own
     * `readinessState` rather than assuming one answer for the whole tool.
     *
    ...
    searchTools(query, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.coreClient.connectExec(this.client.searchTools, (0, protobuf_1.create)(tools_pb_1.SearchToolsRequestSchema, Object.assign(Object.assign({ query }, ((options === null || options === void 0 ? void 0 : options.identifier) && { identifier: options.identifier })), ((options === null || options === void 0 ? void 0 : options.topK) !== undefined && { topK: options.topK }))), { timeoutMs: this.coreClient.toolTimeoutMs });
        });
    }
    /**
