...
const IDLE_CONNECTION_TIMEOUT_CEILING_MS = 240000;
const IDLE_PING_CYCLES_BEFORE_CLOSE = 5;
function idleConnectionTimeoutMsFor(pingIntervalMs) {
    return Math.min(IDLE_CONNECTION_TIMEOUT_CEILING_MS, pingIntervalMs * IDLE_PING_CYCLES_BEFORE_CLOSE);
}
class GrpcConnect {
    constructor(coreClient, timeoutMs = coreClient.timeoutMs) {
        ...
        const keepaliveOptions = this.coreClient.pingIntervalMs
            ...
            : {};
        this.transport = (0, connect_node_1.createGrpcTransport)(Object.assign(Object.assign({ baseUrl: this.coreClient.envUrl, defaultTimeoutMs: timeoutMs }, keepaliveOptions), { interceptors: [
                (next) => {
                    return (req) => {
