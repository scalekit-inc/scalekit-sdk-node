...
class TokenClient {
    ...
    updateToken(token, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.coreClient.connectExec(this.client.updateToken, Object.assign(Object.assign({ token }, ((options === null || options === void 0 ? void 0 : options.customClaims) && { customClaims: options.customClaims })), ((options === null || options === void 0 ? void 0 : options.description) !== undefined && { description: options.description })));
        });
    }
