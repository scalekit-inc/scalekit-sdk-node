...
class ScalekitClient {
    constructor(envUrl, clientId, clientSecret, options) {
        this.coreClient = new core_1.default(envUrl, clientId, clientSecret, options === null || options === void 0 ? void 0 : options.toolTimeoutMs, options === null || options === void 0 ? void 0 : options.timeoutMs);
        ...
        this.auditLogs = new audit_logs_1.default(this.grpcConnect, this.coreClient);
    }
    /**
