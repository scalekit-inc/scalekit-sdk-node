...
class ScalekitClient {
    constructor(envUrl, clientId, clientSecret, options) {
        this.coreClient = new core_1.default(envUrl, clientId, clientSecret, options === null || options === void 0 ? void 0 : options.toolTimeoutMs);
        this.grpcConnect = new connect_1.default(this.coreClient, options === null || options === void 0 ? void 0 : options.timeoutMs);
        ...
        this.actions = new actions_1.default(this.tools, this.connectedAccounts, this.coreClient);
    }
    /**
