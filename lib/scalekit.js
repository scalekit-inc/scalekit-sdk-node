...
const m2mclient_1 = __importDefault(require("./m2mclient"));
const resource_1 = __importDefault(require("./resource"));
const agent_1 = __importDefault(require("./agent"));
const mcp_1 = __importDefault(require("./mcp"));
const tools_1 = __importDefault(require("./tools"));
const connected_accounts_1 = __importDefault(require("./connected-accounts"));
...
class ScalekitClient {
    ...
    forUser(identifier) {
        ...
        return new agent_1.default(identifier, this.actions, this.tools);
    }
    constructor(envUrl, clientId, clientSecret, options) {
        this.coreClient = new core_1.default(envUrl, clientId, clientSecret, options === null || options === void 0 ? void 0 : options.toolTimeoutMs, options === null || options === void 0 ? void 0 : options.timeoutMs, options === null || options === void 0 ? void 0 : options.pingIntervalMs, options === null || options === void 0 ? void 0 : options.pingTimeoutMs);
        ...
        this.m2m = new m2mclient_1.default(this.grpcConnect, this.coreClient);
        this.resources = new resource_1.default(this.grpcConnect, this.coreClient);
        this.tools = new tools_1.default(this.grpcConnect, this.coreClient);
        this.mcp = new mcp_1.default(this.grpcConnect, this.coreClient);
        this.connectedAccounts = new connected_accounts_1.default(this.grpcConnect, this.coreClient);
        this.actions = new actions_1.default(this.tools, this.connectedAccounts, this.coreClient, this.connection);
        this.events = new events_1.default(this.grpcConnect, this.coreClient);
    }
    /**
