...
class ConnectedAccountsClient {
    ...
    listConnectedAccounts(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            })), ((options === null || options === void 0 ? void 0 : options.userId) && { userId: options.userId })), ((options === null || options === void 0 ? void 0 : options.connector) && { connector: options.connector })), ((options === null || options === void 0 ? void 0 : options.identifier) && { identifier: options.identifier })), ((options === null || options === void 0 ? void 0 : options.provider) && { provider: options.provider })), ((options === null || options === void 0 ? void 0 : options.pageSize) !== undefined && { pageSize: options.pageSize })), ((options === null || options === void 0 ? void 0 : options.pageToken) && { pageToken: options.pageToken })), ((options === null || options === void 0 ? void 0 : options.query) && { query: options.query }))));
        });
    }
    /**
    ...
    updateConnectedAccount(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.coreClient.connectExec(this.client.updateConnectedAccount, (0, protobuf_1.create)(connected_accounts_pb_1.UpdateConnectedAccountRequestSchema, Object.assign(Object.assign(Object.assign({ connector,
                identifier,
                connectedAccount }, (organizationId && { organizationId })), (userId && { userId })), (connectedAccountId && { id: connectedAccountId }))));
        });
    }
    /**
    ...
    deleteConnectedAccount(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.coreClient.connectExec(this.client.deleteConnectedAccount, (0, protobuf_1.create)(connected_accounts_pb_1.DeleteConnectedAccountRequestSchema, Object.assign(Object.assign(Object.assign({ connector,
                identifier }, (organizationId && { organizationId })), (userId && { userId })), (connectedAccountId && { id: connectedAccountId }))));
        });
    }
    /**
    ...
    getMagicLinkForConnectedAccount(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const { connector, identifier, organizationId, userId, connectedAccountId, } = params;
            return this.coreClient.connectExec(this.client.getMagicLinkForConnectedAccount, (0, protobuf_1.create)(connected_accounts_pb_1.GetMagicLinkForConnectedAccountRequestSchema, Object.assign(Object.assign(Object.assign({ connector,
                identifier }, (organizationId && { organizationId })), (userId && { userId })), (connectedAccountId && { id: connectedAccountId }))));
        });
    }
    /**
    ...
    getConnectedAccountByIdentifier(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const { connector, identifier, organizationId, userId, connectedAccountId, } = params;
            return this.coreClient.connectExec(this.client.getConnectedAccountAuth, (0, protobuf_1.create)(connected_accounts_pb_1.GetConnectedAccountByIdentifierRequestSchema, Object.assign(Object.assign(Object.assign({ connector,
                identifier }, (organizationId && { organizationId })), (userId && { userId })), (connectedAccountId && { id: connectedAccountId }))));
        });
    }
}
