...
import { type AuthRequestClient, type AuthRequestDetails, type AuthRequestResource, type GetLoginRequestDetailsResponse, type User, type UpdateLoginUserDetailsResponse } from './pkg/grpc/scalekit/v1/auth/auth_pb';
...
export default class AuthClient {
     ...
     */
    getLoginRequestDetails(loginRequestId: string): Promise<GetLoginRequestDetailsResponse>;
}
export type { AuthRequestClient, AuthRequestDetails, AuthRequestResource, GetLoginRequestDetailsResponse, };
