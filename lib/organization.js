...
class OrganizationClient {
    ...
    updateOrganizationSessionPolicy(organizationId, policy) {
        return __awaiter(this, void 0, void 0, function* () {
            const policySource = policy.policySource === 'CUSTOM'
                ? organizations_pb_2.SessionPolicyType.CUSTOM
                : organizations_pb_2.SessionPolicyType.APPLICATION;
            const timeUnitMap = {
                MINUTES: commons_pb_1.TimeUnit.MINUTES,
                HOURS: commons_pb_1.TimeUnit.HOURS,
                DAYS: commons_pb_1.TimeUnit.DAYS,
            };
            const response = yield this.coreClient.connectExec(this.client.updateOrganizationSessionPolicy, Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ organizationId,
                policySource }, (policy.absoluteSessionTimeout !== undefined && {
                absoluteSessionTimeout: policy.absoluteSessionTimeout,
            })), (policy.absoluteSessionTimeoutUnit && {
                absoluteSessionTimeoutUnit: timeUnitMap[policy.absoluteSessionTimeoutUnit],
