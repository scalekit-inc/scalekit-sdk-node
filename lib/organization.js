    ...
    updateOrganizationSessionPolicy(organizationId, policy) {
        return __awaiter(this, void 0, void 0, function* () {
            const policySource = policy.policySource === 'CUSTOM'
                ? organizations_pb_2.SessionPolicySource.CUSTOM
                : organizations_pb_2.SessionPolicySource.APPLICATION;
            const timeUnitMap = {
                MINUTES: commons_pb_1.TimeUnit.MINUTES,
                HOURS: commons_pb_1.TimeUnit.HOURS,
                DAYS: commons_pb_1.TimeUnit.DAYS,
            };
            const response = yield this.coreClient.connectExec(this.client.updateOrganizationSessionPolicy, {
                organizationId,
                policy: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ policySource }, (policy.absoluteSessionTimeout !== undefined && {
