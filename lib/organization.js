...
class OrganizationClient {
     ...
     */
    updateOrganizationSessionPolicy(organizationId, policySource, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.coreClient.connectExec(this.client.updateOrganizationSessionPolicy, Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ organizationId,
                policySource }, ((options === null || options === void 0 ? void 0 : options.absoluteSessionTimeout) !== undefined && {
                absoluteSessionTimeout: options.absoluteSessionTimeout,
            })), ((options === null || options === void 0 ? void 0 : options.absoluteSessionTimeoutUnit) !== undefined && {
                absoluteSessionTimeoutUnit: options.absoluteSessionTimeoutUnit,
            })), ((options === null || options === void 0 ? void 0 : options.idleSessionTimeoutEnabled) !== undefined && {
                idleSessionTimeoutEnabled: options.idleSessionTimeoutEnabled,
            })), ((options === null || options === void 0 ? void 0 : options.idleSessionTimeout) !== undefined && {
                idleSessionTimeout: options.idleSessionTimeout,
            })), ((options === null || options === void 0 ? void 0 : options.idleSessionTimeoutUnit) !== undefined && {
    ...
    getOrganizationSessionPolicy(organizationId) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.coreClient.connectExec(this.client.getOrganizationSessionPolicy, { organizationId });
        });
    }
    /**
