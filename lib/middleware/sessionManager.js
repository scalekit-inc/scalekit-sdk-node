...
class SessionRefreshManager {
    ...
    check(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let payload;
            try {
                payload = yield (0, sessionCrypto_1.decryptSession)(cookieValue, this.secret);
            }
            catch (err) {
    ...
    doRefresh(refreshToken, oldPayload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const newCookieValue = yield (0, sessionCrypto_1.encryptSession)(newPayload, this.secret);
