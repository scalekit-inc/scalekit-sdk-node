...
function deriveKey(secret) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const secretKey = yield webcrypto.subtle.importKey('raw', new TextEncoder().encode(secret), 'HKDF', false, ['deriveBits']);
        const bits = yield webcrypto.subtle.deriveBits({ name: 'HKDF', hash: 'SHA-256', salt: HKDF_SALT, info: HKDF_INFO }, secretKey, 256);
...
function encryptSession(payload, secret) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ciphertextWithTag = new Uint8Array(yield webcrypto.subtle.encrypt({ name: 'AES-GCM', iv: nonce, tagLength: AUTH_TAG_BITS }, key, plaintext));
...
function decryptSession(token, secret) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let payload;
        try {
            const plaintext = yield webcrypto.subtle.decrypt({ name: 'AES-GCM', iv: new Uint8Array(nonce), tagLength: AUTH_TAG_BITS }, key, new Uint8Array(ciphertextWithTag));
