...
export declare const EnvironmentService: {
    ...
    readonly methods: {
         ...
         */
        readonly getRequiredDNSRecords: {
            readonly name: "GetRequiredDNSRecords";
            readonly I: typeof GetDNSRecordsRequest;
            readonly O: typeof GetDNSRecordsResponse;
            readonly kind: MethodKind.Unary;
        };
        /**
         * @generated from rpc scalekit.v1.environments.EnvironmentService.VerifyDNSRecords
         */
        readonly verifyDNSRecords: {
            readonly name: "VerifyDNSRecords";
            readonly I: typeof GetDNSRecordsRequest;
            readonly O: typeof Empty;
            readonly kind: MethodKind.Unary;
        };
        ...
        readonly createCustomDomain: {
            readonly name: "CreateCustomDomain";
            readonly I: typeof CreateCustomDomainRequest;
            readonly O: typeof CreateCustomDomainResponse;
            readonly kind: MethodKind.Unary;
        };
        /**
         * @generated from rpc scalekit.v1.environments.EnvironmentService.CheckCustomDomainStatus
         */
        readonly checkCustomDomainStatus: {
            readonly name: "CheckCustomDomainStatus";
            readonly I: typeof GetEnvironmentRequest;
            readonly O: typeof GetEnvironmentResponse;
            readonly kind: MethodKind.Unary;
        };
