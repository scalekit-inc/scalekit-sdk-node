...
class CoreClient {
    ...
    connectExec(fn, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            return this._connectExec(fn, data, 3, 0, (_a = options === null || options === void 0 ? void 0 : options.retryOn429) !== null && _a !== void 0 ? _a : false);
        });
    }
    _connectExec(fn, data, retryLeft, attempt, retryOn429) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (error instanceof connect_1.ConnectError) {
                    if (retryLeft > 0) {
                        if (error.code === connect_1.Code.Unauthenticated) {
                            ...
                            return this._connectExec(fn, data, retryLeft - 1, attempt + 1, retryOn429);
                        }
