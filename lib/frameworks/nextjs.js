    ...
    createCallbackHandler() {
        return (request) => __awaiter(this, void 0, void 0, function* () {
            ...
            const redirectToLogin = () => {
                const resp = NextResponse.redirect(new URL(this.loginPath, this.baseUrl));
            ...
            const response = NextResponse.redirect(new URL(returnTo !== null && returnTo !== void 0 ? returnTo : this.postLoginRedirect, this.baseUrl));
            const adapter = new NextResponseAdapter(response);
        ...
        return (request) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.fullLogout && idToken) {
                ...
                if (!/^https?:\/\//.test(absoluteRedirectUri)) {
                    absoluteRedirectUri = new URL(absoluteRedirectUri, this.baseUrl).toString();
                }
                const options = {
                    idTokenHint: idToken,
