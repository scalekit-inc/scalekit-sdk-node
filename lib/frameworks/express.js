...
class ScalekitAuth {
    constructor(options) {
        ...
        this.loginHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            new ExpressResponseAdapter(res).setCookie(csrfState_1.STATE_COOKIE_NAME, state, {
        ...
        this.callbackHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const redirectToLogin = () => {
                new ExpressResponseAdapter(res).deleteCookie(csrfState_1.STATE_COOKIE_NAME);
            ...
            const storedState = new ExpressRequestAdapter(req).getCookie(csrfState_1.STATE_COOKIE_NAME);
