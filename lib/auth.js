...
class AuthClient {
     ...
     */
    getLoginRequestDetails(loginRequestId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!loginRequestId || typeof loginRequestId !== 'string') {
                throw new Error('loginRequestId must be a non-empty string');
            }
            const request = (0, protobuf_1.create)(auth_pb_1.GetLoginRequestDetailsRequestSchema, {
                loginRequestId,
            });
            return this.coreClient.connectExec(this.client.getLoginRequestDetails, request);
        });
    }
}
