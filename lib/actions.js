...
class ActionsClient {
    ...
    getAuthorizationLink(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.connectedAccounts.getMagicLinkForConnectedAccount({
                connector: connectionName !== null && connectionName !== void 0 ? connectionName : "",
                identifier: identifier !== null && identifier !== void 0 ? identifier : "",
                organizationId,
                userId,
                connectedAccountId,
            });
    ...
    createConnectedAccount(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connectedAccount = new connected_accounts_pb_1.CreateConnectedAccount(Object.assign({ authorizationDetails }, (apiConfig != null && {
                apiConfig: apiConfig,
            })));
    ...
    updateConnectedAccount(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connectedAccount = new connected_accounts_pb_1.UpdateConnectedAccount(Object.assign(Object.assign({}, (authorizationDetails && { authorizationDetails })), (apiConfig != null && { apiConfig })));
    ...
    request(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const proxyHeaders = Object.assign({ connection_name: connectionName, Connection_name: connectionName, identifier }, (headers !== null && headers !== void 0 ? headers : {}));
