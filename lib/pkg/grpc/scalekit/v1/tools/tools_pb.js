 ...
 */
class ListAvailableToolsRequest extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
         * @generated from field: string identifier = 1;
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(ListAvailableToolsRequest, a, b);
    }
}
exports.ListAvailableToolsRequest = ListAvailableToolsRequest;
ListAvailableToolsRequest.runtime = protobuf_1.proto3;
ListAvailableToolsRequest.typeName = "scalekit.v1.tools.ListAvailableToolsRequest";
ListAvailableToolsRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "identifier", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "page_size", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
    { no: 3, name: "page_token", kind: "scalar", T: 9 /* ScalarType.STRING */ },
]);
 ...
 */
class ListAvailableToolsResponse extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
         * @generated from field: string next_page_token = 1;
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(ListAvailableToolsResponse, a, b);
    }
}
exports.ListAvailableToolsResponse = ListAvailableToolsResponse;
ListAvailableToolsResponse.runtime = protobuf_1.proto3;
ListAvailableToolsResponse.typeName = "scalekit.v1.tools.ListAvailableToolsResponse";
ListAvailableToolsResponse.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "next_page_token", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "total_size", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
    { no: 3, name: "prev_page_token", kind: "scalar", T: 9 /* ScalarType.STRING */ },
