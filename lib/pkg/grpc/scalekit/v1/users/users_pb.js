 ...
 */
class GetCurrentUserResponse extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
...
GetCurrentUserResponse.typeName = "scalekit.v1.users.GetCurrentUserResponse";
GetCurrentUserResponse.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "user", kind: "message", T: User },
 ...
 */
class GetCurrentUserRequest extends protobuf_1.Message {
    constructor(data) {
        super();
        protobuf_1.proto3.util.initPartial(data, this);
    }
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(GetCurrentUserRequest, a, b);
    }
}
exports.GetCurrentUserRequest = GetCurrentUserRequest;
GetCurrentUserRequest.runtime = protobuf_1.proto3;
GetCurrentUserRequest.typeName = "scalekit.v1.users.GetCurrentUserRequest";
GetCurrentUserRequest.fields = protobuf_1.proto3.util.newFieldList(() => []);
/**
 ...
 */
class GetSupportHashResponse extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(GetSupportHashResponse, a, b);
    }
}
exports.GetSupportHashResponse = GetSupportHashResponse;
GetSupportHashResponse.runtime = protobuf_1.proto3;
GetSupportHashResponse.typeName = "scalekit.v1.users.GetSupportHashResponse";
GetSupportHashResponse.fields = protobuf_1.proto3.util.newFieldList(() => [
