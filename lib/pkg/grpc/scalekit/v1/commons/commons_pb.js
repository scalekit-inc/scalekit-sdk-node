...
exports.UserProfile = exports.Role = exports.OrganizationMembership = exports.IdentityProviderType = exports.UserStatus = exports.RegionCode = void 0;
...
(function (UserStatus) {
     ...
     */
    UserStatus[UserStatus["INVITED"] = 3] = "INVITED";
    /**
     * @generated from enum value: PENDING = 4;
     */
    UserStatus[UserStatus["PENDING"] = 4] = "PENDING";
...
OrganizationMembership.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "membership_status", kind: "enum", T: protobuf_1.proto3.getEnumType(UserStatus) },
    { no: 4, name: "roles", kind: "message", T: Role, repeated: true },
    { no: 5, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 6, name: "primary_identity_provider", kind: "enum", T: protobuf_1.proto3.getEnumType(IdentityProviderType) },
