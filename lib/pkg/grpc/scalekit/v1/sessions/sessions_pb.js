 ...
 */
class AuthenticatedClients extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(AuthenticatedClients, a, b);
    }
}
exports.AuthenticatedClients = AuthenticatedClients;
AuthenticatedClients.runtime = protobuf_1.proto3;
AuthenticatedClients.typeName = "scalekit.v1.sessions.AuthenticatedClients";
AuthenticatedClients.fields = protobuf_1.proto3.util.newFieldList(() => [
