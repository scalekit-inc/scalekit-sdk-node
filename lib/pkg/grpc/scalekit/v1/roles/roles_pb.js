...
(function (PermissionType) {
     ...
     */
    PermissionType[PermissionType["ALL"] = 0] = "ALL";
    /**
     * @generated from enum value: SCALEKIT = 1;
     */
    PermissionType[PermissionType["SCALEKIT"] = 1] = "SCALEKIT";
    /**
     * @generated from enum value: ENVIRONMENT = 2;
     */
    PermissionType[PermissionType["ENVIRONMENT"] = 2] = "ENVIRONMENT";
})(PermissionType || (exports.PermissionType = PermissionType = {}));
// Retrieve enum metadata with: proto3.getEnumType(PermissionType)
protobuf_1.proto3.util.setEnumType(PermissionType, "scalekit.v1.roles.PermissionType", [
    { no: 0, name: "ALL" },
    { no: 1, name: "SCALEKIT" },
...
class Permission extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.isScalekitPermission = false;
        protobuf_1.proto3.util.initPartial(data, this);
    }
    static fromBinary(bytes, options) {
...
ListPermissionsRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "type", kind: "enum", T: protobuf_1.proto3.getEnumType(PermissionType) },
]);
/**
