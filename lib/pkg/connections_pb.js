...
(function (ConnectionProvider) {
     ...
     */
    ConnectionProvider[ConnectionProvider["CUSTOM"] = 5] = "CUSTOM";
...
OIDCConnectionConfig.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "well_known_uri", kind: "message", T: protobuf_1.StringValue },
...
class SAMLConnectionConfigRequest extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.requestBinding = RequestBinding.REQUEST_BINDING_UNSPECIFIED;
        /**
...
SAMLConnectionConfigRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    { no: 8, name: "request_binding", kind: "enum", T: protobuf_1.proto3.getEnumType(RequestBinding) },
    { no: 9, name: "saml_signing_option", kind: "enum", T: protobuf_1.proto3.getEnumType(SAMLSigningOptions) },
    { no: 10, name: "allow_idp_initiated_login", kind: "message", T: protobuf_1.BoolValue },
    { no: 11, name: "force_authn", kind: "message", T: protobuf_1.BoolValue },
    { no: 12, name: "default_redirect_uri", kind: "message", T: protobuf_1.StringValue },
    { no: 13, name: "assertion_encrypted", kind: "message", T: protobuf_1.BoolValue },
    { no: 14, name: "want_request_signed", kind: "message", T: protobuf_1.BoolValue },
]);
/**
...
SAMLConnectionConfigResponse.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    { no: 11, name: "request_binding", kind: "enum", T: protobuf_1.proto3.getEnumType(RequestBinding) },
    { no: 12, name: "saml_signing_option", kind: "enum", T: protobuf_1.proto3.getEnumType(SAMLSigningOptions) },
    { no: 13, name: "allow_idp_initiated_login", kind: "message", T: protobuf_1.BoolValue },
 ...
 */
class GetConnectionByDomainRequest extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(GetConnectionByDomainRequest, a, b);
    }
}
exports.GetConnectionByDomainRequest = GetConnectionByDomainRequest;
GetConnectionByDomainRequest.runtime = protobuf_1.proto3;
GetConnectionByDomainRequest.typeName = "scalekit.v1.connections.GetConnectionByDomainRequest";
GetConnectionByDomainRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "domain", kind: "scalar", T: 9 /* ScalarType.STRING */ },
]);
/**
 * @generated from message scalekit.v1.connections.GetConnectionByDomainResponse
 */
class GetConnectionByDomainResponse extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(GetConnectionByDomainResponse, a, b);
    }
}
exports.GetConnectionByDomainResponse = GetConnectionByDomainResponse;
GetConnectionByDomainResponse.runtime = protobuf_1.proto3;
GetConnectionByDomainResponse.typeName = "scalekit.v1.connections.GetConnectionByDomainResponse";
GetConnectionByDomainResponse.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "connection_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "status", kind: "enum", T: protobuf_1.proto3.getEnumType(ConnectionStatus) },
    { no: 3, name: "type", kind: "enum", T: protobuf_1.proto3.getEnumType(ConnectionType) },
