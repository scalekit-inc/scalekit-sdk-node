...
proto3.util.setEnumType(TemplateType, "scalekit.v1.passwordless.TemplateType", [
...
proto3.util.setEnumType(PasswordlessType, "scalekit.v1.passwordless.PasswordlessType", [
...
export class SendPasswordlessRequest extends Message<SendPasswordlessRequest> {
  ...
  static readonly typeName = "scalekit.v1.passwordless.SendPasswordlessRequest";
...
export class SendPasswordlessResponse extends Message<SendPasswordlessResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "scalekit.v1.passwordless.SendPasswordlessResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class VerifyPasswordLessRequest extends Message<VerifyPasswordLessRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "scalekit.v1.passwordless.VerifyPasswordLessRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class ResendPasswordlessRequest extends Message<ResendPasswordlessRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "scalekit.v1.passwordless.ResendPasswordlessRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "auth_request_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class VerifyPasswordLessResponse extends Message<VerifyPasswordLessResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "scalekit.v1.passwordless.VerifyPasswordLessResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "email", kind: "scalar", T: 9 /* ScalarType.STRING */ },
