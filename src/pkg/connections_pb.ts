...
export class SAMLConnectionConfigRequest extends Message<SAMLConnectionConfigRequest> {
   ...
   */
  requestBinding = RequestBinding.REQUEST_BINDING_UNSPECIFIED;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 8, name: "request_binding", kind: "enum", T: proto3.getEnumType(RequestBinding) },
    { no: 9, name: "saml_signing_option", kind: "enum", T: proto3.getEnumType(SAMLSigningOptions) },
    { no: 10, name: "allow_idp_initiated_login", kind: "message", T: BoolValue },
    { no: 11, name: "force_authn", kind: "message", T: BoolValue },
    { no: 12, name: "default_redirect_uri", kind: "message", T: StringValue },
    { no: 13, name: "assertion_encrypted", kind: "message", T: BoolValue },
    { no: 14, name: "want_request_signed", kind: "message", T: BoolValue },
  ]);
...
export class SAMLConnectionConfigResponse extends Message<SAMLConnectionConfigResponse> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 11, name: "request_binding", kind: "enum", T: proto3.getEnumType(RequestBinding) },
    { no: 12, name: "saml_signing_option", kind: "enum", T: proto3.getEnumType(SAMLSigningOptions) },
    { no: 13, name: "allow_idp_initiated_login", kind: "message", T: BoolValue },
